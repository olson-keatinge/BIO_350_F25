...
I realised that this model has very high weight on the feature of Banding year and month and recovery year and month. These features mathematically calculate the age of the birds, so naturally it will have high correlation; it is data leakage. 
...
Banding Flyway, Banding Region, Recovery Flyway, Recovery Region, Sex, How Obtained (shot, salvaged, found dead, etc.), Status (dead/alive)
